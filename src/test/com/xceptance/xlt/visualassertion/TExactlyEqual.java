...
public class TExactlyEqual
{
    ...
    /**
     * Checks whether or not the fuzzyEqual method catches the smallest difference possible as long as the parameters of
     * ImageComparison are (1, 0.0, false, EXACTLYEQUAL)
     * 
     * @throws IOException
     */
    @Test
    ...
    {
        final ImageComparison imagecomparison = new ImageComparison(Algorithm.MATCH, 10, 10, 1, 0.00, 0.01, false, false, 3, 3, false);
        final boolean result = imagecomparison.isEqual(reference, screenshot, fileMask, fileOut, differenceFile);
        Assert.assertFalse("The images arn't quite equal,  he apparently missed something " + "- almostEqualButNotQuite", result);
    }
