...
public class FastBitmap 
{
     ...
     * @param data int array with the data
     */
    ...
    {
        setRGB(x, y, color.getRed(), color.getGreen(), color.getBlue());
    }
    ...
    {    	
        setRGB(point.x, point.y, color.getRed(), color.getGreen(), color.getBlue());
    }
    ...
    {
        int a = pixels[offset] >> 24 & 0xFF;
        pixels[offset] = a << 24 | color.getRed() << 16| color.getGreen() << 8 | color.getBlue();
    }
     ...
     * @param offset Offset.
     * @return pixelsGRAY int value for gray pixel
     */
     ...
     * @param offset Offset.
     * @return pixels int value alpha channel
     */
     ...
     * @param offset Offset.
     * @return pixels int value for red pixel
     */
     ...
     * @param offset Offset.
     * @return pixels int value for green pixels
     */
     ...
     * @param offset Offset.
     * @return int value for blue pixels
     */
    ...
    /***
     * Raster for writing and creating images. 
     */
    private WritableRaster raster;
    
    /***
     * Image representation in array form. 
     */
    private int[] pixels;
    ...
    /***
     * Standard value for the coordination system.
     */
    private CoordinateSystem cSystem = CoordinateSystem.Matrix;
    
    /***
     * Value for matrix dimension size width.
     */
    private int strideX;
    
    /***
     * Value for matrix dimension size height.
     */
    private int strideY;
